...
namespace DotNetty.Buffers
{
    ...
    abstract class PoolArena<T> : IPoolArenaMetric
    {
        ...
        readonly ReadOnlyCollection<IPoolChunkListMetric> chunkListMetrics;
        ...
        protected PoolArena(PooledByteBufferAllocator parent, int pageSize, int maxOrder, int pageShifts, int chunkSize)
        {
            ...
            this.q100 = new PoolChunkList<T>(null, 100, int.MaxValue);
            ...
            this.qInit = new PoolChunkList<T>(this.q000, int.MinValue, 25);
            ...
            this.chunkListMetrics = metrics.AsReadOnly();
        }

        public int NumThreadCaches
        {
            get { return Volatile.Read(ref this.numThreadCaches); }
        }

        public void RegisterThreadCache()
        {
            Interlocked.Increment(ref this.numThreadCaches);
        }

        public void DeregisterThreadCache()
        {
            Interlocked.Decrement(ref this.numThreadCaches);
        }
        ...
        PoolSubpage<T>[] NewSubpagePoolArray(int size)
        {
            return new PoolSubpage<T>[size];
        }
        ...
        {
            return normCapacity.RightUShift(4);
        }
        ...
        void AllocateNormal(PooledByteBuffer<T> buf, int reqCapacity, int normCapacity)
        {
            ...
            if (this.q050.Allocate(buf, reqCapacity, normCapacity) || this.q025.Allocate(buf, reqCapacity, normCapacity)
                ...
                || this.q075.Allocate(buf, reqCapacity, normCapacity) || this.q100.Allocate(buf, reqCapacity, normCapacity))
            {
                return;
            }
        ...
        internal void Free(PoolChunk<T> chunk, long handle, int normCapacity, PoolThreadCache<T> cache)
        {
            if (chunk.Unpooled)
            {
                Interlocked.Decrement(ref this.allocationsHuge);
        ...
        {
            get { return this.tinySubpagePools.Length; }
        }

        public int NumSmallSubpages
        {
            get { return this.smallSubpagePools.Length; }
        }

        public int NumChunkLists
        {
            get { return this.chunkListMetrics.Count; }
        }

        public IReadOnlyList<IPoolSubpageMetric> TinySubpages
        {
            get { return SubPageMetricList(this.tinySubpagePools); }
        }

        public IReadOnlyList<IPoolSubpageMetric> SmallSubpages
        {
            get { return SubPageMetricList(this.smallSubpagePools); }
        }

        public IReadOnlyList<IPoolChunkListMetric> ChunkLists
        {
            get { return this.chunkListMetrics; }
        }
        ...
        {
            get { return this.allocationsTiny + this.allocationsSmall + this.allocationsNormal + this.NumHugeAllocations; }
        }

        public long NumTinyAllocations
        {
            get { return this.allocationsTiny; }
        }

        public long NumSmallAllocations
        {
            get { return this.allocationsSmall; }
        }

        public long NumNormalAllocations
        {
            get { return this.allocationsNormal; }
        }

        public long NumDeallocations
        {
            get { return this.deallocationsTiny + this.deallocationsSmall + this.allocationsNormal + this.NumHugeDeallocations; }
        }

        public long NumTinyDeallocations
        {
            get { return this.deallocationsTiny; }
        }

        public long NumSmallDeallocations
        {
            get { return this.deallocationsSmall; }
        }

        public long NumNormalDeallocations
        {
            get { return this.deallocationsNormal; }
        }

        public long NumHugeAllocations
        {
            get { return Volatile.Read(ref this.allocationsHuge); //allocationsHuge.value();
            }
        }

        public long NumHugeDeallocations
        {
            get { return Volatile.Read(ref this.deallocationsHuge); }
        }
    ...
    sealed class HeapArena : PoolArena<byte[]>
    {
        ...
        {
            return PooledHeapByteBuffer.NewInstance(maxCapacity);
        }
