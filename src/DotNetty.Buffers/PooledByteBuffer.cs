...
namespace DotNetty.Buffers
{
    ...
    abstract class PooledByteBuffer<T> : AbstractReferenceCountedByteBuffer
    {
        ...
        public sealed override IByteBufferAllocator Allocator
        {
            get { return this.Chunk.Arena.Parent; }
        }

        public sealed override ByteOrder Order
        {
            get { return ByteOrder.BigEndian; }
        }

        public sealed override IByteBuffer Unwrap()
        {
            return null;
        }
